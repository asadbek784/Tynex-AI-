    ...
    <div className="border-t border-border bg-[#0B0F19] px-4 py-4 z-10 relative">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted/50 hover:text-primary transition-all disabled:opacity-50"
        ...
        {/* Main input area */}
        <div className="relative flex flex-1 items-end gap-2 rounded-lg border border-border bg-muted/30 backdrop-blur-sm transition-all focus-within:border-primary/50 focus-within:shadow-lg focus-within:shadow-primary/10">
          <textarea
            ref={textareaRef}
            value={value}
          ...
          <div className="flex gap-1 pr-2 pb-1">
            ...
            <button
              ...
              disabled={disabled}
              className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded transition-all disabled:opacity-50 ${
                isListening
                  ? 'bg-red-500/20 text-red-400 animate-pulse'
                  : 'text-muted-foreground hover:bg-muted hover:text-[#00D4FF]'
              }`}
            ...
            <button
              ...
              className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded bg-[#00D4FF] text-background transition-all hover:shadow-lg hover:shadow-[#00D4FF]/50 active:scale-95 disabled:opacity-50"
              title="Yuborish"
            >
