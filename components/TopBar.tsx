      ...
      <div className="flex items-center gap-3">
        ...
        {models.length > 0 && (
          <div className="relative group">
            <button className="flex items-center gap-2 rounded-lg border border-border bg-muted/20 px-3 py-2 text-sm font-medium text-secondary hover:bg-muted/40 hover:text-foreground transition-colors group-hover:border-primary/50">
              <Bot className="h-4 w-4 text-primary" />
              {activeModel ? activeModel.displayName : 'Modelni tanlang'}
              <svg
                className="h-4 w-4"
                fill="none"
                stroke="currentColor"
