    ...
    <>
      ...
      >
                      ...
                      <div
                        ...
                        className={`group relative flex items-center justify-between w-full rounded-lg px-3 py-2 text-left text-sm transition-all cursor-pointer ${
                          isSelected
                            ...
                            : 'text-secondary hover:bg-muted/30 hover:text-foreground'
                        }`}
                      >
                        {isEditing ? (
        ...
        <div className="border-t border-border p-4 space-y-2">
          {/* Settings / Info */}
          <div className="flex w-full items-center gap-3 px-3 py-2 text-xs text-secondary border border-border/40 rounded-lg bg-card/60">
            <span className="font-semibold text-[#00D4FF] uppercase">Limit:</span>
            <span>3 soatda 25 ta xabar</span>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2 text-secondary hover:bg-muted/50 hover:text-foreground transition-colors"
            >
